...
import com.xxzhwx.util.PlatformDependent;
        ...
        private void processCancelledTasks() {
            for (;;) {
                ...
                try {
                    ...
                    System.err.println("An exception was thrown while process a cancellation task:" + t);
                }
            }
        }
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        public boolean cancel() {
            ...
            timer.cancelledTimeouts.add(() -> {
                HashedWheelBucket bucket1 = HashedWheelTimeout.this.bucket;
                if (bucket1 != null) {
                    bucket1.remove(HashedWheelTimeout.this);
                }
            });
            return true;
        }
        ...
        public void expire() {
            ...
            try {
                ...
                System.err.println("An exception was thrown by " + TimerTask.class.getSimpleName() + '.' + t);
            }
        }
